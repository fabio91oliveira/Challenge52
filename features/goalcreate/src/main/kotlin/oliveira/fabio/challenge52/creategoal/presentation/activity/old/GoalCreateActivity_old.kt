...
//import java.util.*
//
//class GoalCreateActivity_old : BaseActivity(R.layout.activity_challenge_select) {
//
...
//            goalCreateViewState.observe(this@GoalCreateActivity_old, Observer {
//                btnCreate.isEnabled = it.isCreateButtonEnable
//            })
//            goalCreateActions.observe(this@GoalCreateActivity_old, Observer {
//                when (it) {
