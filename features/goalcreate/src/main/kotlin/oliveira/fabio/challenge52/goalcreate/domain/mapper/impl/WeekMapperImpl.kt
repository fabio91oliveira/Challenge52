package oliveira.fabio.challenge52.goalcreate.domain.mapper.impl
...
internal class WeekMapperImpl :
    WeekMapper {
    override fun invoke(goal: GoalEntity, id: Long) = mutableListOf<ItemEntity>().apply {
        goal.id = id
